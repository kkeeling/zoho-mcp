...
@pytest.fixture
def mock_zoho_api():
    """Create a mock for the zoho_api_request_async function."""
    with patch("zoho_mcp.tools.contacts.zoho_api_request_async") as mock:
...
class TestContactTools:
    ...
    @pytest.mark.asyncio
    async def test_list_contacts_all(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_list_contacts_customers(self, mock_zoho_api):
        ...
        result = await list_contacts(contact_type="customer")
    ...
    @pytest.mark.asyncio
    async def test_list_contacts_with_pagination(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_list_contacts_with_search(self, mock_zoho_api):
        ...
        result = await list_contacts(search_text="Test Customer")
    ...
    @pytest.mark.asyncio
    async def test_list_contacts_error(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_create_customer_success(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_create_customer_validation_error(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_create_customer_api_error(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_create_vendor_success(self, mock_zoho_api):
    ...
    @pytest.mark.asyncio
    async def test_get_contact_success(self, mock_zoho_api):
        """Test getting a contact successfully."""
        mock_zoho_api.return_value = MOCK_CONTACT_RESPONSE
        
        result = await get_contact(contact_id="123456789")
    ...
    @pytest.mark.asyncio
    async def test_get_contact_not_found(self, mock_zoho_api):
        """Test getting a contact that doesn't exist."""
        mock_zoho_api.return_value = {"message": "Contact not found"}
        
        result = await get_contact(contact_id="nonexistent")
    ...
    @pytest.mark.asyncio
    async def test_get_contact_error(self, mock_zoho_api):
        """Test error handling when getting a contact."""
        mock_zoho_api.side_effect = ZohoRequestError(400, "Bad Request")
        
        with pytest.raises(ZohoRequestError):
            await get_contact(contact_id="123456789")
    
    @pytest.mark.asyncio
    async def test_delete_contact_success(self, mock_zoho_api):
        """Test deleting a contact successfully."""
        mock_zoho_api.return_value = MOCK_DELETE_RESPONSE
        
        result = await delete_contact(contact_id="123456789")
    ...
    @pytest.mark.asyncio
    async def test_delete_contact_error(self, mock_zoho_api):
        """Test error handling when deleting a contact."""
        mock_zoho_api.side_effect = ZohoRequestError(400, "Bad Request")
        
        with pytest.raises(ZohoRequestError):
            await delete_contact(contact_id="123456789")